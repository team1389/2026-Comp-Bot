...
public class RobotMap {
    ...
    public static final double HoodIntegralCorr = 0.00016541; // How aggressivly hood fixes position error
    public static final int HoodMaxAmp = 40; // Max motor current allowed (avoid brown out)
    public static final double HoodRampRatePID = .25; // In seconds time to ramp from 0 to full output in PID mode
    public static final double HoodRampRateMan = .25; // In seconds time to ramp from 0 to full output in manual mode
    public static final int HoodGearRatio = 4;
    public static final double HoodStaticVolts = 0.27937; // Volts needed to overcome static friction and make hood move
    ...
    public static final boolean HoodMoterInvert = false; //True if the hood moter is inverted relative to the angle rotation
